<script>
const title = "Investors | cyclic.sh"
const description = ""
    ...
    <b-container class="pt-20 space-y-12">
      ...
      <b-row>
        ...
        <b-col md="7" lg="5" align-self="center" class="space-y-4 text-lg">
          ...
          <p>
            Over <strong>50,000 developers have found us</strong> and signed up and thousands use Cyclic on a daily basis.
          </p>
          <p>
            We started with
        ...
        <b-col md="5" lg="5"  >
          <div class="text-center mt-5 space-y-2">
            <div>
              <NuxtImg loading="lazy" class="mx-auto" src="images/logos/big_logo.png" width="300px" alt="Invest in Cyclic" />
            </div>
            <div class="spacer-32"></div>
