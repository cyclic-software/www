      ...
      <div class="pt-20 space-y-12">
        ...
        <b-row>
          ...
          <b-col  md="6" lg="5" class="hero-images" align-self="center">
                <div class="vs-images">
                  <NuxtImg format="webp" loading="lazy" class="vs-image" src="/images/vs/heroku-logo-solid-gradient.svg" width="150px" alt='Heroku' />
                  <!-- <div class="spacer-16"></div> -->
                  <div class="vs-text">vs</div>
                  <!-- <div class="spacer-16"></div> -->
                  <NuxtImg format="webp" loading="lazy" class="vs-image" src="/images/logos/icon-dark.svg" width="150px" alt='Cyclic' />
                </div>
              <!-- </b-col>
            </b-row> -->
          </b-col>
